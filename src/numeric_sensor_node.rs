...
use homie5::{
    HOMIE_UNIT_AMPERE, HOMIE_UNIT_DEGREE_CELSIUS, HOMIE_UNIT_HERTZ, HOMIE_UNIT_KILOPASCAL,
    HOMIE_UNIT_KILOWATTHOUR, HOMIE_UNIT_LITER, HOMIE_UNIT_LUX, HOMIE_UNIT_METER,
    HOMIE_UNIT_PERCENT, HOMIE_UNIT_VOLT, HOMIE_UNIT_WATT, Homie5DeviceProtocol, HomieID, NodeRef,
    device_description::{
